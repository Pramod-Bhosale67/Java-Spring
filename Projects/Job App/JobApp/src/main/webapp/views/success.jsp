...
<%@ page import="com.codegreedy.JobApp.model.JobPost" %>
...
<%
    JobPost myJobPost = (JobPost) request.getAttribute("jobPosts");
%>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card border-dark bg-dark text-white">
                <div class="card-body">
                    <h5 class="card-title">${jobPosts.postProfile}</h5>
                    <p class="card-text">
                    ...
                    <p class="card-text">
                        ...
                        ${jobPosts.reqExperience} years
                    </p>
                    <p class="card-text">
                        <strong>Tech Stack Required:</strong>
                        <ul>
                            <c:forEach var="tech" items="${jobPosts.postTechStack}">
                                <li>${tech}</li>
                            </c:forEach>
                        </ul>
                    </p>
